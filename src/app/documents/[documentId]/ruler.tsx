  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    if ((isDraggingLeft || isDraggingRight) && rulerRef.current) {
      ...
      if (isDraggingLeft) {
        ...
        setLeftMargin(newLeftPosition); // TODO: Mark collaborative
                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      ...
                      <span
                        className="absolute bottom-2 text-[10px] text-neutral-500 
  ...
  return (
    <div
      className="absolute cursor-ew-resize
       top-0 w-4 h-full group -ml-2 z-[5]"
    ...
    top-0 h-full fill-blue-500 transform -translate-x-1/2"
      />
      <div
